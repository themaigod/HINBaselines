...
from utils import load_acm_process, EarlyStopping
...
def main(args):
    ...
    val_mask, test_mask = load_acm_process(args)
    ...
    with open(result_path, 'a', newline='') as f:
        writer = csv.writer(f)
        writer.writerow([args["dataset"], labels, args["seed"], test_micro_f1, test_macro_f1])
