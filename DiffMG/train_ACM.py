...
parser.add_argument('--no_norm', action='store_true', default=True, help='disable layer norm')
parser.add_argument('--in_nl', action='store_true', default=True, help='non-linearity after projection')
