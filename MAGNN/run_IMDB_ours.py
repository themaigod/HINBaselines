...
from load_dataset import process_imdb
...
ap.add_argument("--label", type=str, default="../data/IMDB/labels_5_fold_cross_validation_4.pkl")
...
def run_model_IMDB(feats_type, num_layers, hidden_dim, num_heads, attn_vec_dim, rnn_type,
    ...
    nx_G_lists, edge_metapath_indices_lists, features_list, adjM, type_mask, labels, train_val_test_idx = process_imdb(
        r"../data/IMDB", labels_path)
