...
all_edges, node_type_features, labels, train_idx, val_idx, test_idx = load_datasets("../data/DBLP",
...
all_edges, node_type_features, labels, train_idx, val_idx, test_idx = load_datasets("../data/DBLP", two_direct=True, labels_path=args.label)
G = dgl.heterograph(all_edges)
print(G)
